...
describe("FileUploadService", () => {
    let service;
    beforeEach(() => {
        service = new fileUploadService_1.FileUploadService();
        jest.clearAllMocks();
    });
    describe("validateFile", () => {
        ...
        it("파일 크기가 너무 클 때 에러를 발생시켜야 함", () => {
            ...
            expect(() => service.validateFile(mockFile)).toThrow(errorHandler_1.FileUploadError);
        ...
        <root>&xxe;</root>`;
            ...
            expect(() => service.validateFile(mockFile)).toThrow(errorHandler_1.SecurityError);
...
//# sourceMappingURL=fileUploadService.test.js.map