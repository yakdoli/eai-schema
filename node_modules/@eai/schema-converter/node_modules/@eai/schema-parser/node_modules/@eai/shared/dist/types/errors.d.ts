...
export declare enum ParsePhase {
...
export declare enum ConversionPhase {
...
export type ApplicationError = ParsingError | ValidationError | ConversionError | MappingError | ComparisonError | NetworkError | FileSystemError | SecurityError | ConfigurationError | SystemError;
...
export declare enum ValidationRuleResult {
    PASSED = "PASSED",
    FAILED = "FAILED",
    SKIPPED = "SKIPPED",
    ERROR = "ERROR"
...
export declare enum FallbackType {
